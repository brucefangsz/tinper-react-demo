...
export default class App extends Component {
  ...
  renderBreadcrumb = () => {
    ...
    BreadcrumbDom.push(
      <Breadcrumb.Item active>{this.state.current}</Breadcrumb.Item>
    );
        ...
        <Navbar fluid expanded={this.state.expanded} onToggle={this.onToggle}>
          <Nav pullRight>
            <NavItem eventKey={3} className="icon-nav">
              <a href="http://tinper.org" target="_blank">
                {" "}
                <Icon type="uf uf-qm-c" /> 帮助{" "}
              </a>
              <a className="" href="#">
                <img
                  alt=""
                  className="avatar float-left mr-1"
                  src="https://avatars3.githubusercontent.com/u/3817644?s=460&v=4"
                  height="20"
                  width="20"
                />
                admin
          ...
          <div className="sider-menu">
            <div className="logo-header">
              <a href="#">
                <img
                  style={{ width: 140 }}
                  src="//tinper.org/assets/images/tinperlogos32.png"
                />
              </a>
            </div>
            <Menu
